...
namespace Arena
{
	...
	ARENA_API size_t GetNumChannels(uint64_t pixelFormat);

	ARENA_API size_t GetBitsPerChannel(uint64_t pixelFormat);

	ARENA_API size_t GetBytesPerStep(uint64_t pixelFormat);

	ARENA_API size_t GetPixelsPerStep(uint64_t pixelFormat);
} // namespace Arena

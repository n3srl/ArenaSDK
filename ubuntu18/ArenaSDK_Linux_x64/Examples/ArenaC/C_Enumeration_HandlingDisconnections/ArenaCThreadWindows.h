...
/**
* @fn void acThreadConditionVariableWait(CONDITION_VARIABLE* conditionVariable, CRITICAL_SECTION* pMutex);
*
* @param conditionVariable
...
*  - Returns AC_ERR_SUCCESS (0) on success
*
* <B> acThreadConditionVariableWait </B> waits for the thread to be signalled awake.
*/
void acThreadConditionVariableWait(CONDITION_VARIABLE* pConditionVariable, CRITICAL_SECTION* pMutex);

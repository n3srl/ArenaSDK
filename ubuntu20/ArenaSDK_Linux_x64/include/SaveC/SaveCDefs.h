 ...
 *
 * This enum represents the different subsampling options when saving JPEG
 * images.
 *
 * @warning
 *  - Use SC_JPEG_SUBSAMPLING integer values in place of
 *    SC_JPEG_SUBSAMPLING_LIST enum values
 */
enum SC_JPEG_SUBSAMPLING_LIST
{
...
*
 * This enum represents the different compression options when saving TIFF
 * images.
*
* @warning
 *  - Use SC_TIFF_COMPRESSION integer values in place of
 *    SC_TIFF_COMPRESSION_LIST enum values
*/
enum SC_TIFF_COMPRESSION_LIST
{
...
/**
* @fn SC_ERROR SC_API saveGetVersion(char* pVersionBuf, size_t* pBufLen)
*
* @param pVersionBuf
*  - Type: char*
*  - [Out] parameter
...
*
* <B> saveGetVersion </B> get build version
*/
SC_ERROR SC_API saveGetVersion(char* pVersionBuf, size_t* pBufLen);
